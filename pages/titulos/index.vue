        ...
        <form ref="form" class="card py-4 p-3" @submit.prevent="onSubmit">
          ...
          <div class="row justify-content-center">
            ...
            <div class="col-12 col-md-10 col-lg-6">
              ...
              <div class="form-group">
                <label for="Combustible" class="form-label mt-4"
                  >Combustible del vehiculo</label
                >
                <ValidationProvider v-slot="{ errors }" rules="required|alpha">
                  <input
                    id="fuel"
              ...
              <div class="form-group">
                <label for="formFile" class="form-label mt-4"
                  >Foto del titulo anterior</label
                >
    ...
    return {
      ...
      meta: [
        ...
        },
        {
          ...
          name: 'keywords',
          content:
            'placas y titulos, titulos, titulos de carros, titulos y placas',
        },
      ],
    }
  },
